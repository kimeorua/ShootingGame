...
UPawnUIComponent* UShootingGameGameplayAbility::GetPawnUIComponentFromActorInfo() const
{
	return GetAvatarActorFromActorInfo()->FindComponentByClass<UPawnUIComponent>();
}
